...
class UserDetailsControllerTest < ActionController::TestCase
  ...
  test "should create user_detail" do
    assert_difference('UserDetail.count') do
      post :create, user_detail: { email: @user_detail.email, fname: @user_detail.fname, lname: @user_detail.lname, user_id: @user_detail.user_id }
    end
  ...
  test "should update user_detail" do
    put :update, id: @user_detail, user_detail: { email: @user_detail.email, fname: @user_detail.fname, lname: @user_detail.lname, user_id: @user_detail.user_id }
    assert_redirected_to user_detail_path(assigns(:user_detail))
  end
